...
<div class="container-fluid top-container">
  <div class="row-a">
     <img src="../images/logo.png" class="logo">
       <a class="res-soc-link"  href="www.youtube.com" style="padding-left:1000px;"><img src="../images/q5.png" ></a>  
        ...
        <div class="col-lg-8 order-lg-1 personal-info">
            <form role="form">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="TAHI" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Prénom</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" value="Siham" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Email</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="email" value="gs_tahi@esi.dz" />
                    </div>
                </div>
                  <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input class="form-control" type="text" value="" placeholder="Commune" />
                    </div>
                    <div class="col-lg-3">
                        <input class="form-control" type="text" value="" placeholder="Wilaya" />
                    </div>
                </div>
