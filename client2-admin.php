<?php
     ...
     $clientssupp=$req->recupClSuppCon();
...
<table  class="table table-sm" id ="mydataTable2">
 ...
 <?php foreach ($clientsbloc as $clientbl): ?>
      <tr>
        <td> <?= $clientbl['nom'] ?></td> 
        <td> <?= $clientbl['prenom'] ?></td>
        <td> <?= $clientbl['mail'] ?> </td>
        <td> <?= $clientbl['adresse'] ?></td>
        <td> <?= $clientbl['commune'] ?></td>
        <td> <?= $clientbl['wilaya'] ?></td>
        <td> <?= $clientbl['numTel'] ?></td >
        <td> <?= $clientbl['faxe'] ?></td>
        <td> <?= $clientbl['photo'] ?></td>     
      </tr>  
    <?php endforeach; ?>
  </tbody>
</table>
<br> <br>  
 <h1 class="text-center text-primary">La liste des Clients supprimés</h1> 
      <br> <br>   
<table  class="table table-sm" id ="mydataTable3">
 ...
 <?php foreach ($clientssupp as $clientsup): ?>
      <tr>
        <td> <?= $clientsup['nom'] ?></td> 
        <td> <?= $clientsup['prenom'] ?></td>
        <td> <?= $clientsup['mail'] ?> </td>
        <td> <?= $clientsup['adresse'] ?></td>
        <td> <?= $clientsup['commune'] ?></td>
        <td> <?= $clientsup['wilaya'] ?></td>
        <td> <?= $clientsup['numTel'] ?></td >
        <td> <?= $clientsup['faxe'] ?></td>
        <td> <?= $clientsup['photo'] ?></td>     
      </tr>  
    <?php endforeach; ?>
  </tbody>
</table>
